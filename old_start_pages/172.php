...
<div>
    ...
    <div class="lang_container">
      ...
      <a href="<?php echo get_site_url(1) . '?page_id=162&db=172'; ?>">
   ...
   <div class="lang_container">
		<span style="white-space: nowrap;">
      <a href="<?php echo get_site_url(1) . '/fr/?page_id=4&db=172'; ?>">
   ...
   <div class="lang_container">
		<span style="white-space: nowrap;">
      <a href="<?php echo get_site_url(1) . '/it/?page_id=10&db=172'; ?>">
  ...
  <div style ="white-space: nowrap; display: inline-block;"> 
    ...
    <div class="lang_container">
  		<span style="white-space: nowrap;">
        <a href="<?php echo get_site_url(1) . '/rg/?page_id=162&db=172'; ?>">
    ...
    <div class="lang_container">
  		<span style="white-space: nowrap;">
      <a href="<?php echo get_site_url(1) . '/si/?page_id=5&db=172'; ?>">
