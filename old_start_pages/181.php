...
include_once '181_header.php';

$url = get_site_url(1);
?>

<div class="version_div"> <object type="image/svg+xml" width="35px" data="<?php echo $url?>/wp-content/themes/verba-alpina/old_start_pages/181_version.svg"></object></div>
  ...
  <div id="logoSVG" style="position: relative;">
    ...
    <div class="logo_container">
       ...
       <div class="circle_container">
          <img title="Deutsch" data-link="<?php echo get_site_url(1) . '?page_id=162&db=181'; ?>" class="lang_circle" src="<?php echo $url?>/wp-content/themes/verba-alpina/images/circle_de.svg.png">
          <img title="Français" data-link="<?php echo get_site_url(1) . '/fr/?page_id=4&db=181'; ?>" class="lang_circle" src="<?php echo $url?>/wp-content/themes/verba-alpina/images/circle_fr.svg.png">
          <img title="Italiano" data-link="<?php echo get_site_url(1) . '/it/?page_id=10&db=181'; ?>" class="lang_circle" src="<?php echo $url?>/wp-content/themes/verba-alpina/images/circle_it.svg.png">
          <img title="Slovenščina" data-link="<?php echo get_site_url(1) . '/si/?page_id=5&db=181'; ?>" class="lang_circle" src="<?php echo $url?>/wp-content/themes/verba-alpina/images/circle_sl.svg.png">
          <img title="Rumantsch Grischun" data-link="<?php echo get_site_url(1) . '/rg/?page_id=162&db=181'; ?>" class="lang_circle" src="<?php echo $url?>/wp-content/themes/verba-alpina/images/circle_rg.svg.png">
