...
include_once '221_header.php';
 
 $url = get_site_url(1);
?>

<div class="version_div"> <img type="image/svg+xml" width="35px" src="<?php echo $url?>/wp-content/themes/verba-alpina/old_start_pages/221_version.svg"></img></div>
